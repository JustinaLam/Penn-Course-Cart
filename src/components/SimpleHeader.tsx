...
const SimpleHeader = ({courseList, courseTitleList}: CheckoutProps) => {
    const navigate = useNavigate();
    return (
        <>
    <NavBar id="nav">
        <Logo id="logo" onClick={(e)=>goHome(courseList, courseTitleList, navigate)}>Penn Course Cart</Logo>
...
function goHome(courseList: Array<Course>, courseTitleList: Array<String>, navigate: NavigateFunction) {
    navigate("/", { state: {courseList: courseList, courseTitleList: courseTitleList} });
}
